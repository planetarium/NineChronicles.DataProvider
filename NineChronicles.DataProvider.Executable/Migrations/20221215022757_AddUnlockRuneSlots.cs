...
{
    public partial class AddUnlockRuneSlots : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "UnlockRuneSlots",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnlockRuneSlots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnlockRuneSlots_Agents_AgentAddress",
                        column: x => x.AgentAddress,
                        principalTable: "Agents",
                        principalColumn: "Address");
                    table.ForeignKey(
                        name: "FK_UnlockRuneSlots_Avatars_AvatarAddress",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnlockRuneSlots_AgentAddress",
                table: "UnlockRuneSlots",
                column: "AgentAddress");

            migrationBuilder.CreateIndex(
                name: "IX_UnlockRuneSlots_AvatarAddress",
                table: "UnlockRuneSlots",
